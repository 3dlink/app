	           ...
	           <td><?php echo h($item['Client']['payment']); ?>&nbsp;</td>
                        ...
                        <td>
	                        ...
	                        <?php if($this->UserAuth->getGroupId() == 1){ ?>
	  	                      ...
	  	                      <a href="<?php echo $this->webroot;?>clients/delete/<?php echo $item['Client']['id'];?>" onclick="if (confirm(&quot;Are you sure you want to delete the client from our database?&quot;)) { return true; } return false;" class="menuTable">
...
<p>
<?php echo $this->Paginator->counter(array('format' => __('Page {:page} of {:pages}, showing {:current} Clients of {:count}  total.')));?>
</p>
<ul class="pagination">
<?php
