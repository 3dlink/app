	           ...
	           <td><?php echo h($item['Destination']['ranking']); ?>&nbsp;</td>
                        ...
                        <td>
	                        ...
	                        <?php if($this->UserAuth->getGroupId() == 1){ ?>
	  	                      ...
	  	                      <a href="<?php echo $this->webroot;?>destinations/delete/<?php echo $item['Destination']['id'];?>" onclick="if (confirm(&quot;Are you sure you want to delete the destination?&quot;)) { return true; } return false;" class="menuTable">
...
<p>
<?php echo $this->Paginator->counter(array('format' => __('Page {:page} of {:pages}, showing {:current} Destinations of {:count}  total.')));?>
</p>
<ul class="pagination">
<?php
