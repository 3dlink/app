<div class="comments index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($comment['Destination']['name'], array('controller' => 'destinations', 'action' => 'view', $comment['Destination']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($comment['User']['name'], array('controller' => 'users', 'action' => 'view', $comment['User']['id'])); ?>
		</td>
		<td><?php echo h($comment['Comment']['security']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['environment']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['budget']); ?>&nbsp;</td>
		<td class="actions">
