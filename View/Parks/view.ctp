...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Park'), array('action' => 'delete', $park['Park']['id']), array(), __('Are you sure you want to delete # %s?', $park['Park']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($park['Destination'] as $destination): ?>
		<tr>
